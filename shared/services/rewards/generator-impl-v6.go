...
func (r *treeGeneratorImpl_v6) fetchEpochs(startEpoch uint64, endEpoch uint64, errChan chan error, startTime time.Time) {
...
func (r *treeGeneratorImpl_v6) fetchEpoch(getDuties bool, epoch uint64) (*epochState, error) {
...
func (r *treeGeneratorImpl_v6) processEpoch(es *epochState) {
